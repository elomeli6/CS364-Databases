...
* UPDATED to MySQL syntax by Alex LeClerc
*********************************************************/
DROP SCHEMA IF EXISTS guitarshop;
CREATE SCHEMA guitarshop;
USE guitarshop;
...
CREATE TABLE Products (
  ...
  DiscountPercent   DECIMAL(15,2)  NOT NULL      DEFAULT 0.00,
...
CREATE TABLE Orders (
  ...
  ShipAmount        DECIMAL(15,2)  NOT NULL,
